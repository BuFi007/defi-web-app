...
- ⏭ Next: A.6 social OAuth (Discord/X/TG real verify); A.8 payment verify (USDC/JPYC → agent); A.9 swap+bridge inline (desk-v1); base-thumbnail rendering in picker; reserved base art; prod layer hosting; MCP mint tool (EIP-1271 agent SCAs); asset alpha cutout; upgrade flow.
