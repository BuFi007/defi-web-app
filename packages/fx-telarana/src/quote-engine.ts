import { MAX_UINT_256, ORACLE_PRICE_SCALE, WAD } from "./constants";
import { mulDivDown, toAssetsDown, toAssetsUp, toSharesDown } from "./morpho-math";
import type { BorrowQuote, LendingMarket } from "./types";

export function calculateCollateralValueE18(
...
export function quoteBorrow(args: {
  ...
  const currentBorrow =
    args.existingBorrowShares &&
    args.totalBorrowAssets !== undefined &&
    args.totalBorrowShares !== undefined
