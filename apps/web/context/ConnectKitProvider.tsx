...
const bufxTheme = {
  ...
  "--ck-connectbutton-box-shadow": "0 0 0 1px rgba(91, 56, 192, 0.15)",
  "--ck-connectbutton-hover-color": "#5B38C0",
  "--ck-connectbutton-hover-background": "#EDEAF5",
  "--ck-connectbutton-hover-box-shadow": "0 0 0 1px rgba(91, 56, 192, 0.4)",
  "--ck-connectbutton-active-color": "#5B38C0",
  "--ck-connectbutton-active-background": "#E2D0FD",
  "--ck-connectbutton-active-box-shadow": "0 0 0 1px #5B38C0",
