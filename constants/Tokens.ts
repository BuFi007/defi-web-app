...
export const AvalancheFujiTokens: Token[] = [
  ...
  {
    address: "0x5085f96Fab5A4F4cD6AceDf8054b431AaCf298f9" as Hex,
    chainId: 43113,
    decimals: 18,
    name: "WETH",
    payable: true,
...
export const SepoliaOptimismTokens: Token[] = [
  {
    address: NATIVE_TOKEN_ADDRESS,
    chainId: 11155111,
    decimals: 18,
  ...
  {
    address: "0x5fd84259d66Cd46123540766Be93DFE6D43130D7" as Hex,
    chainId: 11155111,
    decimals: 6,
    name: "USDC",
    payable: true,
...
export const BscTestnetTokens: Token[] = [
  {
    address: NATIVE_TOKEN_ADDRESS,
    chainId: 97,
    decimals: 18,
...
export const ModeTestnetTokens: Token[] = [
  ...
  {
    address: "0x85cbB40e56F19789012B0F1fE5d49c71148B99dC" as Hex,
    chainId: 919,
    decimals: 18,
    name: "BUFI",
    payable: true,
