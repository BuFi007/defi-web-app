...
import { instructions } from "@/lib/ai-config/conversation-config";
import { WavRenderer } from "@/lib/ai-config/wav-render";
import { X, Edit, Zap, ArrowUp, ArrowDown } from "lucide-react";
import { Button } from "@/components/boofi-ghost-card/Button";
    ...
    client.addTool(
      {
        name: "send_eth",
        description:
          "Sends a specified amount of ETH to a given address or Basename.",
        parameters: {
          type: "object",
          properties: {
            to: {
    ...
    client.addTool(
      {
        ...
        description:
          "Retrieves the current account balance of the connected wallet.",
        parameters: {
          type: "object",
          properties: {},
          required: [],
    ...
    client.addTool(
      {
        ...
        description:
          "Retrieves the current USDC balance of the connected wallet.",
        parameters: {
          type: "object",
          properties: {},
          required: [],
    ...
    client.addTool(
      {
        ...
        description:
          "Opens a new tab with Blockscout to verify the user's USDC balance.",
        parameters: {
          type: "object",
          properties: {},
          required: [],
  ...
  return (
    <LayoutAuthCardAiAssistant>
      <div className="relative content-logs">
        ...
        <div
          className={`content-block waveform`}
        ...
        <div className="content-actions flex flex-col items-center justify-center flex-grow">
          {isConnected && canPushToTalk && (
            <Button
              ...
              className={` ${
                isRecording ? "large-button" : "large-button-blue"
