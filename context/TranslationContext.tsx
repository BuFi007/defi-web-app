...
export function TranslationProvider({ children }: { children: ReactNode }) {
  ...
  const translations: Translations = {
    ...
    PeanutTab: {
      ...
      handleClaimToastTitle: t('PeanutTab.handleClaimToastTitle'),
      handleClaimToastDescription: t('PeanutTab.handleClaimToastDescription'),
      ...
      currentTextAlreadyClaimedTitle: t('PeanutTab.currentTextAlreadyClaimedTitle'),
      ...
      currentTextCrossChainProgress: t('PeanutTab.currentTextCrossChainProgress'),
      ...
      currentTextCrossChainComplete: t('PeanutTab.currentTextCrossChainComplete'),
    ...
    MoneyMarketBento1: {
      tabLend: t('MoneyMarketTab1.tabLend'),
      tabBorrow: t('MoneyMarketTab1.tabBorrow'),
      tabWithdraw: t('MoneyMarketTab1.tabWithdraw'),
      tabRepay: t('MoneyMarketTab1.tabRepay'),
      depositUSDC: t('MoneyMarketTab1.depositUSDC'),
      withdrawUSDC: t('MoneyMarketTab1.withdrawUSDC'),
      borrowUSDC: t('MoneyMarketTab1.borrowUSDC'),
      repayUSDC: t('MoneyMarketTab1.repayUSDC'),
      toastSwitchTitle: t('MoneyMarketTab1.toastSwitchTitle'),
      toastSwitchDescription: t('MoneyMarketTab1.toastSwitchDescription'),
      toastSwitchDescription2: t('MoneyMarketTab1.toastSwitchDescription2'),
      labelFrom: t('MoneyMarketTab1.labelFrom'),
      labelTo: t('MoneyMarketTab1.labelTo'),
    },
    MoneyMarketBento3: {
...
export function useAppTranslations<K extends keyof Translations>(
    ...
    if (!context) {
      throw new Error('useAppTranslations must be used within a TranslationProvider');
    }
