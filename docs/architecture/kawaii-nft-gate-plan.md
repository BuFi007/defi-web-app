...
- ⏭ Next: A.6 social OAuth (Discord/X/TG real verify); A.9 swap+bridge inline (desk-v1, Fuji); base-thumbnail rendering; reserved base art; prod layer hosting; MCP mint tool (EIP-1271 agent SCAs); asset alpha cutout; mainnet tier + upgrade flow (USDC/JPYC on Avax).
