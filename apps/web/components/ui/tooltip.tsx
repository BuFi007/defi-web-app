      ...
      <TooltipPrimitive.Portal>
        <TooltipPrimitive.Content
          ...
          className={cn(
            ...
            // side state changes.
            "z-[100] max-w-[320px] overflow-hidden rounded-2xl border border-purpleDanis/20 bg-white px-3 py-2 text-xs font-bold text-main shadow-lg",
            "dark:bg-black dark:text-white dark:border-violetDanis/30",
