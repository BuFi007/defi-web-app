...
- ⏭ Next: register the 3 social apps + add creds (activates A.6); A.9 swap+bridge inline (desk-v1, Fuji); base-thumbnail rendering; reserved base art; prod layer hosting; MCP mint tool (EIP-1271 agent SCAs); asset alpha cutout; mainnet tier + upgrade flow (USDC/JPYC on Avax).
