...
- ⏭ Next: A.5 wallet-session wiring; A.6 social OAuth (Discord/X/TG); A.7 gate modal (Tower clone, additive, `/browse`); A.8 payment verify; A.9 swap+bridge (desk-v1); A.10 nanopay advert; MCP mint tool (EIP-1271 for agent SCAs); asset alpha cutout.
